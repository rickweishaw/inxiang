<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"H:\WWW\inx\public/../application/user\view\detail\detail.html";i:1554025644;}*/ ?>
<!DOCTYPE html>
<html lang="cmn-hans">
<head>
...
<body>
    <div class="pure-g container">
      ...
      <aside class="pure-u-8-24">
        <div class="user">
          <img src="<?php echo $avatar; ?>"><span><?php echo $name; ?></span>
        ...
        <div class="pure-menu pure-menu-horizontal action">
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item"><a href="#" class="pure-menu-link">私信Ta</a></li>
            </ul>
        </div>
      </aside>
    </div>
