...
class email extends Controller
{
    ...
    public function index(){
        ...
        $mail->Subject = "小印相 -- 请尽快验证你的新邮箱地址"; // 邮件标题
        $mail->Body = "修改成功，你在本站更改的邮箱需要验证！请点击 http://inxiang.net/account/checkNum/?email=$toemail&num=$number (或者复制到浏览器打开)，完成验证！"; // 邮件正文

        if ($mail->send()) {
            return $this->success('发件成功，请到邮箱查阅');
        } else {
